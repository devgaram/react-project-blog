...
const AboutContainer = () => {
  ...
  return (
    <>
      <Switch>
        <Route
          path={`${path}/portfolios/:id/edit`}
          component={PortfolioEditContainer}
        />
        <Route
          path={`${path}/portfolios/:id/preview`}
          component={PortfolioPreviewContainer}
        />
        <Route
          path={`${path}/portfolios/new`}
          component={PortfolioEditContainer}
        />
