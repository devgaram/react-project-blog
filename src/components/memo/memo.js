    ...
    <>
      <div className="top-space-mid">
        <div className="memo-container">
          ...
          <div className="memo-title title-label label label-large" hidden>
            제목
          </div>
          <div
            ...
            hidden
          ></div>
          <div className="memo-content content-label label label-large">
            메모 작성...
          </div>
          <div
          ...
          <div className="memo-tool-group" hidden>
            <div className="icon-list" role="toolbar">
              <Tooltip title="배경색 변경" placement="bottom">
                <IconTool
                  className="memo-icons"
                  aria-label="배경색 변경"
                  role="button"
                  type="bg-colors"
                />
              </Tooltip>
              <Tooltip title="라벨 추가" placement="bottom">
                <IconTool
                  className="memo-icons"
                  aria-label="라벨 추가"
                  role="button"
              ...
              <Tooltip title="체크박스 표시" placement="bottom">
                <IconTool
                  className="memo-icons"
                  aria-label="체크박스 표시"
                  role="button"
            ...
            <Button
              className="memo-btn-close"
              size="small"
              type="link"
              style={{ color: "rgb(73, 72, 72)" }}
            >
              닫기
            </Button>
